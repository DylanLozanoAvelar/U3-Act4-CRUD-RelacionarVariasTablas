...
$sentenciaProductos = $base_de_datos->prepare("SELECT a.codigo, a.nombreGasolina, a.precio, av.litros
FROM tbl_articulos a
INNER JOIN 
tbl_articulos_vendidos av
ON a.idGasolina = av.id_articulo
WHERE av.id_venta = ?");
        ...
        <table>
            ...
            <tbody>
                ...
                foreach ($productos as $producto) {
                    $subtotal = $producto->precio * $producto->litros;
                    $total += $subtotal;
                ?>
                    <tr>
                        <td class="cantidad"><?php echo $producto->litros;  ?></td>
                        <td class="producto"><?php echo $producto->nombreGasolina;  ?> <strong>$<?php echo number_format($producto->precio, 2) ?></strong></td>
