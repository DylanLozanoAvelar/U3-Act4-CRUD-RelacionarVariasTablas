...
GROUP_CONCAT(
    CONCAT(tbl_articulos.codigo, '..', tbl_articulos.nombreGasolina, '..', tbl_articulos_vendidos.litros) 
    SEPARATOR '__'
) AS productos
FROM tbl_ventas 
INNER JOIN tbl_articulos_vendidos ON tbl_articulos_vendidos.id_venta = tbl_ventas.id_venta 
INNER JOIN tbl_articulos ON tbl_articulos.idGasolina = tbl_articulos_vendidos.id_articulo 
